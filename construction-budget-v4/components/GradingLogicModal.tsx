            ...
            <div className="space-y-8 text-[#1E2D5C]">
                ...
                <section>
                    ...
                    <p className="text-sm mb-4">
                        The Risk Score measures the potential downside of a project. <strong className="text-red-600">A higher score indicates higher risk.</strong>
                    </p>
                ...
                <section>
                    ...
                    <p className="text-sm mb-4">
                        The Deal Grade is a weighted composite score. <strong className="text-green-600">A higher score indicates a better deal.</strong>
                    </p>
